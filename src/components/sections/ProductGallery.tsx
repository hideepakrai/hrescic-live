  ...
  return (
    <section className="flex flex-col items-center gap-5">
      ...
      <div className="relative w-full max-w-3xl">
        ...
        <button
          className="absolute left-0 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow hover:bg-gray-100 transition"
        ...
        <button
          className="absolute right-0 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow hover:bg-gray-100 transition"
