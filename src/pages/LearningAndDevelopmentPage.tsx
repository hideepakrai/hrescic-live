...
const caseCards = [
  {
    title: "Case - ",
    highlight: "Intro",
    text: "One example of turning fragmented learning & development products into a cohesive, scalable system.",
    image: "/assets/Image/learning & developments-case-img.png",
  ...
  },
  {
    ...
    image: "/assets/Image/learning & developments-case-1.png",
  ...
  },
  {
    title: "Case - ",
    highlight: "Summary",
    text: "Coaching.com operated across independently developed learning & development programs, software and marketplace services. The challenge wasn't growth,  it was unifying structure, experience and delivery without limiting future evolution.",
    image: "/assets/Image/learning & developments-case-2.png",
          ...
          <div className="grid overflow-hidden rounded-[18px] bg-[#FFF0F5] lg:grid-cols-[0.98fr_1.02fr]">
              ...
              <div className="w-full px-4 py-7 sm:px-8 sm:py-10 md:px-10 md:py-7 lg:pb-[74px] lg:ps-[75px] lg:pe-8">
                ...
                <div className="pt-8">
                  <h1
                    ...
                    Learning & development brands don't scale by adding more products. They scale by creating clarity.
                  </h1>

                  <p className="mt-5 sm:mt-6 lg:mt-4 max-w-[430px] text-[15px] sm:text-[17px] leading-[1.75] text-[#0F0F3D]">
               We help learning & development businesses align programs, platforms and content into one coherent system — built to scale without losing trust, structure or focus.
                  </p>

                  <div className="mt-4 sm:mt-8 lg:mt-6 flex flex-col gap-3">
                    <GoldButton href="/lets-talk#ask">
                      Talk about scaling your learning & development business
                    </GoldButton>

                    <GoldButton href="/lets-talk#demo">
                     See how learning & development platforms grow with us
                    </GoldButton>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 lg:order-2 p-[2px]">
              <div className="relative h-[260px] overflow-hidden sm:h-[340px] md:h-[430px] lg:h-full lg:min-h-[552px]">
                <img
                  src="/assets/Image/learning & development-imgs.png"
        ...
        <div className="mx-auto container-xl rounded-[2px]">
          <div className="px-4 py-10 sm:px-8 sm:py-12 md:px-10 lg:px-[120px] lg:py-[68px]">
            <div className="mx-auto  text-center">
              ...
              >
                The reality of learning & development today
              </h2>

              <p className="mx-auto mt-3 max-w-[420px] text-[14px] sm:text-[15px] leading-[1.55] text-[#0F0F3D]">
                Learning & development businesses grow fast, and then stall.
              </p>
            </div>
          ...
          <div className="overflow-hidden rounded-[14px] bg-[#EBE1F7]">
            <div className="grid border-b border-[#e2dbd7] bg-[#F7F0FF] lg:grid-cols-[1.02fr_0.98fr]">
              <div className="px-4 py-8 sm:px-8 sm:py-10 md:px-10 lg:ps-[86px] lg:pe-[24px] lg:pb-[56px] lg:pt-[34px]">
                <h3 className="text-[14px] sm:text-[22px] font-semibold text-[#5E1DE1]">
                  What actually drives growth in learning & development
                </h3>
                ...
                <p
                  ...
                  style={{ fontFamily: "Georgia, Times New Roman, serif" }}
                >
                  Learning & development growth doesn't come from more courses, more tools or more features.  It comes from clarity across the entire learning ecosystem — from first touchpoint to program delivery.
                </p>
              </div>

              <div className="flex items-center justify-center px-5 py-7 sm:px-8 sm:py-8 md:px-10 lg:px-[46px]">
                <img
                  src="/assets/Image/learning & developments-growth-img.png"
            ...
            <div className="px-4 py-8 sm:px-8 sm:py-10 md:px-10 lg:px-[86px] lg:pb-[50px] lg:pt-[60px]">
              <h3
                ...
                style={{ fontFamily: "Georgia, Times New Roman, serif" }}
              >
                learning & development brands grow when they have:
              </h3>
              ...
              <div className="mt-9 sm:mt-12 lg:mt-[48px] flex items-start gap-3 sm:gap-4">
                ...
                <p
                  ...
                  style={{ fontFamily: "Georgia, Times New Roman, serif" }}
                >
                  That's what we build by aligning brand, UX, content and structure into one scalable learning & development system.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto container-xl">
          <div className="text-center">
            <h2
              ...
              style={{ fontFamily: "Georgia, Times New Roman, serif" }}
            >
              How this works in real learning ecosystems:
            </h2>
          ...
          <div className="mt-8 flex justify-center">
            <GoldButton href="/who-we-create-for/cdc">
              See how clarity enables scale in learning & development
            </GoldButton>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto container-xl">
          <div className="mx-auto max-w-[760px] text-left lg:ml-[108px]">
            <h3 className="text-[16px] sm:text-[17px] font-semibold text-[#0F0F3D]">
              Why clarity beats complexity in learning & development?
            </h3>
            ...
            <p
              ...
              style={{ fontFamily: "Georgia, Times New Roman, serif" }}
            >
              Learning & development businesses don't struggle because they lack expertise. They struggle because complexity hides value.
            </p>
          </div>
            ...
            <div className="overflow-hidden rounded-[16px] bg-[#fff] border border-[#EEEEEE] p-4 lg:grid lg:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="grid grid-cols-2 gap-4 p-4">
                ...
                <div className="col-span-1 row-span-2 rounded-[12px] overflow-hidden bg-[#F2EAF8]">
                  <img
                    src="/assets/Image/learning & development-images-2.png"
                ...
                <div className="rounded-[12px] overflow-hidden bg-[#F8EAF2]">
                  <img
                    src="/assets/Image/learning & development-images-1.png"
                    alt="Learning & Development ad graphic"
                    className="h-full w-full object-cover"
                  />
                </div>
                ...
                <div className="rounded-[12px] overflow-hidden bg-[#F3EAF8]">
                  <img
                    src="/assets/Image/learning & development-images.png"
        ...
        <div className="mx-auto container-xl">
          <div className="flex flex-col items-center justify-center px-2 sm:px-4 py-4 sm:py-8 text-center">
            <h2
              ...
              style={{ fontFamily: "Georgia, Times New Roman, serif" }}
            >
              Ready to scale your learning & development business without losing clarity?
            </h2>

            <p className="mt-4 max-w-[470px] text-[15px] sm:text-[16px] leading-[1.6] text-[#0F0F3D]">
              Let's talk about structuring your learning & development ecosystem for growth — without fragmentation.
            </p>

            <div className="mt-7 flex w-full max-w-[420px] flex-col items-center gap-3">
              <GoldButton href="/lets-talk#demo">
                Book an Learning & development strategy call
              </GoldButton>
              <GoldButton href="/lets-talk#ask">
